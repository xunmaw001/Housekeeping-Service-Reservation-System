<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服务守则" prop="fuwushouze">
          <el-input v-model="ruleForm.fuwushouze" 
              placeholder="服务守则" clearable  :readonly="ro.fuwushouze"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服务守则" prop="fuwushouze">
              <el-input v-model="ruleForm.fuwushouze" 
                placeholder="服务守则" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服务时长" prop="fuwushizhang">
          <el-input v-model="ruleForm.fuwushizhang" 
              placeholder="服务时长" clearable  :readonly="ro.fuwushizhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服务时长" prop="fuwushizhang">
              <el-input v-model="ruleForm.fuwushizhang" 
                placeholder="服务时长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
